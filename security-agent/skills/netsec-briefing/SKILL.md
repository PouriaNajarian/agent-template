...
description: NETWORK SECURITY SCANNER. You MUST use this skill whenever the user mentions: "scan my network", "network security", "security audit", "check for vulnerabilities", "open ports", "find vulnerable services", "security briefing", "nmap scan", or any request about scanning, auditing, or assessing their home or office network. This skill runs nmap to discover hosts and detect services on a private subnet, then produces a structured security briefing. Read this SKILL.md FIRST before running any nmap c
---
