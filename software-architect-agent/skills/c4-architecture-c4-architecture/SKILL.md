...
- â Every subdirectory has a corresponding c4-code-\*.md file
- â All code-level documentation includes complete function signatures
- â Components are logically grouped with clear boundaries
- â All components have interface documentation
- â Master component index created with relationship diagram
- â Containers map to actual deployment units
- â All container APIs documented with OpenAPI/Swagger specs
- â Container diagram shows deployment architecture
- â System context includes all personas (human and programmatic)
- â User journeys documented for all key features
- â All external systems and dependencies identified
- â Context diagram shows system, users, and external systems
- â Documentation is organized in C4-Documentation/ directory

## Output Structure

```
C4-Documentation/
âââ c4-code-*.md              # Code-level docs (one per directory)
âââ c4-component-*.md          # Component-level docs (one per component)
âââ c4-component.md            # Master component index
âââ c4-container.md            # Container-level docs
âââ c4-context.md              # Context-level docs
âââ apis/                      # API specifications
    âââ [container]-api.yaml   # OpenAPI specs for each container
    âââ ...
```
