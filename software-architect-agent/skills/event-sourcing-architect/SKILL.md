...
- Use durable execution for process managers and sagas â frameworks like DBOS persist workflow state automatically, making cross-aggregate orchestration resilient to crashes
